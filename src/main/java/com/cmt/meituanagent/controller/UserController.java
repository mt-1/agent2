package com.cmt.meituanagent.controller;
...
import com.cmt.meituanagent.common.ResultUtils;
import com.cmt.meituanagent.constant.UserConstant;
...
import com.cmt.meituanagent.model.dto.user.*;
...
public class UserController {
    ...
    public BaseResponse<Long> userRegister(@RequestBody UserRegisterRequest userRegisterRequest){
        ...
        ThrowUtils.throwIf(StrUtil.isBlank(userAccount) || StrUtil.isBlank(userPassword) || StrUtil.isBlank(checkPassword), ErrorCode.PARAMS_ERROR, "账号或密码为空");
