...
public class WebScreenshotUtils {
    ...
    public static String saveWebPageScreenshot(String webUrl) {
        ...
        try {
            ...
            log.info("原始截图保存路径：{}", imageSavePath);
            // 压缩图片
            ...
            log.error("生成网页截图失败:{}", e.getMessage());
            return null;
        }
    ...
    private static void waitForPageLoad(WebDriver webDriver) {
        try {
            ...
            log.error("页面加载超时： {}", e.getMessage(), e);
            throw new BusinessException(ErrorCode.SYSTEM_ERROR, "页面加载超时");
        }
    }
